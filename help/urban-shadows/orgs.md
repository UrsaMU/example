...
List organizations. Players see public ones; staff sees all.
Optionally filter by circle: mortalis, night, power, or wild.
...
Set private staff-only notes (plot hooks, current plans, etc.).
